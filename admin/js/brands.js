$(document).ready(function(){
			...
			success : function(response){
				...
				$.each(resp.message, function(index, value){
					brandHTML += '<tr>'+
									...
									'<td><a class="btn btn-sm btn-info edit-brand"><span style="display:none;">'+JSON.stringify(value)+'</span><i class="fas fa-pencil-alt"></i></a>&nbsp;<a bid="'+value.discount_id+'" class="btn btn-sm btn-danger delete-brand"><i class="fas fa-trash-alt"></i></a></td>'+'</tr>';
				});
	...
	$(document.body).on("click", ".edit-brand", function(){
		...
		console.log(brand);
		$("input[name='e_discount_title']").val(brand.discount_title);
		$("input[name='discount_id']").val(brand.discount_id);
