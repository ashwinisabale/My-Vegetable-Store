        ...
        <form id="add-product-form" enctype="multipart/form-data">
        	<div class="row">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		...
		        		<select class="form-control brand_list" name="discount_id">
            ...
            <div class="col-12">
              <div class="form-group">
        		...
        		<div class="col-12">
        			<div class="form-group">
		        		<label>Product Keywords <small>(eg: Vegetable, Fruits)</small></label>
        ...
        <form id="edit-product-form" enctype="multipart/form-data">
          <div class="row">
            ...
            <div class="col-12">
              <div class="form-group">
                <label>Discount %</label>
                <select class="form-control brand_list" name="e_discount_id">
                  <option value="">Select Discount</option>
                </select>
              </div>
            </div>
